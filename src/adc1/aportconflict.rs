...
#[doc = "Reader of field `APORT0XCONFLICT`"]
pub type APORT0XCONFLICT_R = crate::R<bool, bool>;
#[doc = "Reader of field `APORT0YCONFLICT`"]
pub type APORT0YCONFLICT_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn aport0xconflict(&self) -> APORT0XCONFLICT_R {
        APORT0XCONFLICT_R::new((self.bits & 0x01) != 0)
    }
    ...
    pub fn aport0yconflict(&self) -> APORT0YCONFLICT_R {
        APORT0YCONFLICT_R::new(((self.bits >> 1) & 0x01) != 0)
    }
